...
## 为什么这个项目有价值
太长不看版（直接看效果）：
https://13752303161-design.github.io/data-desensitization-skill/
...
```text
把这份 PPT 做轻度脱敏，发给当前接收方继续讨论，保留趋势和结构，但真实数字全部扰动。
```
...
如果仓库启用了 GitHub Pages，建议把首页作为公开入口：

- `index.html`
  作为 Pages 落地页，集中引导到交互式示例、设计说明和 `SKILL.md`
